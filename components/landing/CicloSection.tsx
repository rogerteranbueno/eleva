      ...
      <div className="max-w-6xl mx-auto space-y-14">
        ...
        >
          ...
          <h2 className="text-4xl sm:text-5xl font-black text-white leading-tight">
            ...
            <span className="text-white/55 font-light italic">Instalamos el ciclo completo.</span>
          </h2>
              ...
              return (
                <div key={c.label} className="flex items-center">
                  ...
                  >
                    ...
                    <span
                      className="text-[10px] font-bold text-center leading-tight transition-colors max-w-[60px]"
                      style={{ color: isActive ? c.color : "#ffffff99" }}
                    >
                      {c.label}
                    </span>
                  </motion.button>
                  ...
                  {i < CICLO.length - 1 && (
                    <div className="w-5 h-px mx-0.5 flex-shrink-0 bg-gradient-to-r from-white/15 to-white/5" />
                  )}
                </div>
              )
            })}
              ...
              >
                ...
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    <p className="font-black text-white text-base">{CICLO[active].label}</p>
                  ...
                  <p className="text-sm text-white/70 leading-relaxed">{CICLO[active].desc}</p>
                </div>
              </div>
            </motion.div>
          )}
        ...
        >
          {RESULTADOS.map((r, i) => (
            <div
              key={r.value}
              className="glass rounded-xl p-4 border border-white/6 text-center space-y-1"
            >
              <p className={`text-sm font-bold ${accentText[r.accent] ?? "text-white"} leading-snug`}>{r.value}</p>
        ...
        >
          <Link href="/metodo">
            <button className="inline-flex items-center gap-2 px-6 py-3 bg-violet-600 hover:bg-violet-500 text-white font-bold rounded-xl transition-colors text-sm group">
