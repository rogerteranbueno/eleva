...
const PROFILES = [
  {
    email:       "dueno@level.com",
    password:    "Level2026",
    role:        "Dueño del Centro",
    persona:     "Pedro García",
    tagline:     "Pulso, finanzas, CRM y equipo",
    icon:        BarChart3,
    accent:      "violet",
  },
  {
    email:       "coach@level.com",
    password:    "Level2026",
    role:        "Coach",
    persona:     "Pedro Infante",
  ...
  },
  {
    ...
    password:    "Level2026",
    role:        "Operaciones",
    persona:     "Sandra Molina",
    tagline:     "Inscripciones, pagos y reportes",
    icon:        ClipboardList,
    accent:      "emerald",
  },
  {
    email:       "sara@level.com",
    password:    "Level2026",
    role:        "Participante",
    persona:     "Sara Alzate",
    tagline:     "Feed, misiones y comunidad",
    icon:        Heart,
    accent:      "pink",
  },
] as const
