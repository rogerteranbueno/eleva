...
import { CURRENT_MISSION } from "@/data/level"
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-0.5">PL · Semana 12 de 20</p>
      </div>
      ...
      <div className="glass rounded-xl p-5 space-y-3">
        <div className="flex items-center justify-between">
          <h3 className="font-semibold text-white text-sm">Progreso en PL</h3>
