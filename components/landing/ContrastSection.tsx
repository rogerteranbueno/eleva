    ...
    <section className="section-a relative py-20">
      <div className="max-w-5xl mx-auto px-6">
        ...
        >
          ...
          <Link href="/demo/pulso" className="flex-shrink-0 flex items-center gap-2 px-5 py-2.5 rounded-xl border border-cyan-500/40 hover:bg-cyan-500/10 text-cyan-300 text-sm font-bold transition-colors whitespace-nowrap">
