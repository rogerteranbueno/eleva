        ...
        <motion.div custom={0} variants={fadeUp} className="space-y-2">
          ...
          <div className="flex items-start gap-4 flex-wrap">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-5xl sm:text-6xl font-black text-white tracking-tight">PACTO</h2>
            </div>
          </div>
        ...
        >
          ...
          <div className="p-8 grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div className="space-y-6">
              ...
              {/* Price */}
              <div className="glass rounded-2xl p-5 border border-white/8 space-y-1">
                <p className="text-xs text-muted-foreground uppercase tracking-widest font-bold">Inversión</p>
                <p className="text-3xl font-black text-white">Desde USD $15,000</p>
              ...
              <Link href="/build">
                <button className="w-full flex items-center justify-center gap-2 px-6 py-4 bg-violet-600 hover:bg-violet-500 text-white font-bold rounded-xl transition-colors group">
                  Aplicar a PACTO
