...
export function NumbersSection() {
  ...
  const c = lang === "en" ? {
    badge: "02 · Results",
    h2a: "Numbers the industry",
    h2b: "can't ignore.",
    sub: "When a center operates with data, growth stops depending on enrollment.",
    heroEyebrow: "Average growth · 12 months",
    heroLabel: "Active participants",
    heroSub: "vs. centers without a tracking system. Without hiring more staff.",
    stat2Eyebrow: "Conversion",
    stat2Val: "68%",
    stat2Sub: "phase-to-phase with active follow-up",
    stat2Sub2: "vs. 41% without it",
    stat3Eyebrow: "Retention",
    stat3Val: "3x",
    stat3Sub: "more with active Momentum Score per participant",
    stat4Eyebrow: "Enrollment",
    stat4Val: "80%",
    stat4Sub: "easier when the lead received valuable content first",
    stat5Eyebrow: "Owner's time",
    stat5Val: "4 hrs",
    stat5Sub: "recovered per week, without changing the methodology",
    footerText: "The",
    footerBold: "+140% growth",
    footerText2: "is not a projection: it's the average for centers with more than 12 months in the system.",
    footerCta: "See the system",
  } : {
    badge: "02 · Resultados",
    h2a: "Números que el sector",
    h2b: "no puede ignorar.",
    sub: "Cuando un centro opera con datos, el crecimiento deja de depender del enrolamiento.",
    heroEyebrow: "Crecimiento promedio · 12 meses",
    heroLabel: "Participantes activos",
    heroSub: "vs. centros sin sistema de seguimiento. Sin contratar más staff.",
    stat2Eyebrow: "Conversión",
    stat2Val: "68%",
    stat2Sub: "fase a fase con seguimiento activo",
    stat2Sub2: "vs. 41% sin él",
    stat3Eyebrow: "Retención",
    stat3Val: "3x",
    stat3Sub: "más con Momentum Score activo por participante",
    stat4Eyebrow: "Enrolamiento",
    stat4Val: "80%",
    stat4Sub: "más fácil cuando el lead recibió contenido de valor antes",
    stat5Eyebrow: "Tiempo del dueño",
    stat5Val: "4 hrs",
    stat5Sub: "semanales recuperadas, sin cambiar la metodología",
    footerText: "El",
    footerBold: "+140% de crecimiento",
    footerText2: "no es una proyección: es el promedio de centros con más de 12 meses en el sistema.",
