...
const INSIGHTS: InsightDef[] = [
  {
    ...
    composer: {
      ...
      messages: {
        whatsapp: "Hola {nombre} 🌟 Soy Carlos de TRANSFORMA. Te he visto un poco desconectado estos días y quería saber cómo estás. Tu proceso nos importa, ¿hay algo en lo que pueda apoyarte? Aquí estoy para ti.",
        emailSubject: "Carlos de TRANSFORMA quería saber cómo estás 💙",
        emailBody: "Hola {nombre},\n\nNos has faltado en TRANSFORMA.\n\nSé que la vida tiene altibajos y eso está completamente bien. Lo que importa es que no estás solo en este proceso, el equipo y yo estamos aquí.\n\n¿Qué está pasando? ¿Cómo puedo apoyarte esta semana?\n\nCon cariño,\nCarlos Mendoza\nTRANSFORMA",
        sms: "Hola {nombre}, Carlos de TRANSFORMA aquí. ¿Todo bien? Te echamos de menos. Escríbeme cuando puedas, aquí estoy. 🌟",
  ...
  },
  {
    ...
    composer: {
      ...
      messages: {
        ...
        sms: "Gen. Norte: sesión especial con Marco esta semana. Confirma asistencia respondiendo SÍ. TRANSFORMA 🔥",
